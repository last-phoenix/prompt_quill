                ...
                for combo in combos:
                    ...
                    for log, running, good in self.process_and_score_image(
                        ...
                        db.execute("""
                                ...
                                """, (None, model, lora_combo, pos_lora, neg_lora, pos_embedding, neg_embedding, sampler, scheduler, vae, score, prompt, 0, topic, self.last_file, json.dumps(self.actual_score['scores']), json.dumps(self.actual_score['penalties'])))
                        db.commit()
